...
const API_KEY='27a3b418dfab4b2c9598e754c0ebc34b'
...
//console.log(VideogameFormat);
  ...
  VideogameFormat.forEach(
    async ({
      ...
      //   const newPlatforms = await Platforms.findOne({ where: { name: platforms } });
      //   await newVideogame.addPlatforms(newPlatforms);
      // });
